...
def init():
    with MongoDBSaver.from_conn_string(MONGODB_URI) as checkpointer:
        ...
        last_message = state.values["messages"][-1] # last message because to check it is tool call or not
        ...
        resume_command = Command(resume={"data": ans})  # resuming the graph because it was interupted because ai did'nt know the answer
